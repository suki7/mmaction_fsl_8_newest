...
log_level = 'INFO'
work_dir = './work_dirs/ggwang/fewshot_sthv2_meta_with_cfa/'

# for backbone training
# load_from = None

# for fewshot training
# load_from = './work_dirs/ggwang/fewshot_sthv2_resnet_with_cfa/epoch_6.pth'
load_from = '/data1/wrye/mmaction_fsl/work_dirs/resnet/epoch_6.pth'
